	...
	for i in range(steps[n][0]):
		for j in range(steps[n][1]):
			if not(ps[n][i][j]==0):
				...
				for pt1 in wn:
					for pt2 in wn:
						if not((pt1==pt2)or(ps[n][pt1[1][0]][pt1[1][1]]==0)or(ps[n][pt2[1][0]][pt2[1][1]]==0)):
							if (((abs(pt1[1][0]-pt2[1][0])+abs(pt1[1][1]-pt2[1][1]))==4)or((abs(pt1[1][0]-pt2[1][0])==2)and(pt1[1][0]==i)and(pt2[1][0]==i))or((abs(pt1[1][1]-pt2[1][1])==2)and(pt1[1][1]==j)and(pt2[1][1]==j)))and((ps[n][pt1[1][0]][pt1[1][1]]<ps[n][i][j])and(ps[n][pt2[1][0]][pt2[1][1]]<ps[n][i][j])):
