...
thres=float(input())
print('Processing...')
layer=shapefile.Reader("shapes/Lakes")
shapes=layer.shapes()
xs=[]
ys=[]
stx=[]
...
xis=[]
yis=[]
edt=shapefile.Editor(shapefile="shapes/Lakes")
...
for n in range(len(shapes)):
	...
	for w in drpt[n]:
		...
		if len(w[3])==1:
			...
			drpt[n][w[5]].append(dw[0])
	exn=0
	for w in drpt[n]:
		if len(w[3])==1:
			ext_lines[n].append([[w[5], w[3][0], w[8]]])
			ext_lines[n][exn][0][2]+=math.sqrt((xxs[n][w[1][0]][w[1][1]]-xxs[n][drpt[n][w[3][0]][1][0]][drpt[n][w[3][0]][1][1]])**2+(yys[n][w[1][0]][w[1][1]]-yys[n][drpt[n][w[3][0]][1][0]][drpt[n][w[3][0]][1][1]])**2)
			ext_flag=True
			while ext_flag:
				ext_flag=False
				exw=0
				ext_add=[]
				for wrn in ext_lines[n][exn]:
					if wrn[0]==wrn[1]:
						exw+=1
						continue
					wr=drpt[n][wrn[1]]
					if len(wr[3])==1:
						ext_lines[n][exn][exw][2]+=wr[8]
						ext_lines[n][exn][exw][0]=ext_lines[n][exn][exw][1]
						if ext_lines[n][exn][exw][2]>lengs[n]:
							lengs[n]=ext_lines[n][exn][exw][2]
					elif len(wr[3])==2:
						ext_flag=True
						if wr[3][0]==ext_lines[n][exn][exw][0]:
							ext_lines[n][exn][exw][2]+=math.sqrt((xxs[n][wr[1][0]][wr[1][1]]-xxs[n][drpt[n][wr[3][1]][1][0]][drpt[n][wr[3][1]][1][1]])**2+(yys[n][wr[1][0]][wr[1][1]]-yys[n][drpt[n][wr[3][1]][1][0]][drpt[n][wr[3][1]][1][1]])**2)
							ext_lines[n][exn][exw][0]=ext_lines[n][exn][exw][1]
							ext_lines[n][exn][exw][1]=wr[3][1]
						if wr[3][1]==ext_lines[n][exn][exw][0]:
							ext_lines[n][exn][exw][2]+=math.sqrt((xxs[n][wr[1][0]][wr[1][1]]-xxs[n][drpt[n][wr[3][0]][1][0]][drpt[n][wr[3][0]][1][1]])**2+(yys[n][wr[1][0]][wr[1][1]]-yys[n][drpt[n][wr[3][0]][1][0]][drpt[n][wr[3][0]][1][1]])**2)
							ext_lines[n][exn][exw][0]=ext_lines[n][exn][exw][1]
							ext_lines[n][exn][exw][1]=wr[3][0]
					elif len(wr[3])==3:
						ext_flag=True
						if wr[3][0]==ext_lines[n][exn][exw][0]:
							dwd=wrn[2]+math.sqrt((xxs[n][wr[1][0]][wr[1][1]]-xxs[n][drpt[n][wr[3][2]][1][0]][drpt[n][wr[3][2]][1][1]])**2+(yys[n][wr[1][0]][wr[1][1]]-yys[n][drpt[n][wr[3][2]][1][0]][drpt[n][wr[3][2]][1][1]])**2)
							ext_add.append([wr[5], wr[3][2], dwd])
							ext_lines[n][exn][exw][2]+=math.sqrt((xxs[n][wr[1][0]][wr[1][1]]-xxs[n][drpt[n][wr[3][1]][1][0]][drpt[n][wr[3][1]][1][1]])**2+(yys[n][wr[1][0]][wr[1][1]]-yys[n][drpt[n][wr[3][1]][1][0]][drpt[n][wr[3][1]][1][1]])**2)
							ext_lines[n][exn][exw][0]=ext_lines[n][exn][exw][1]
							ext_lines[n][exn][exw][1]=wr[3][1]
						if wr[3][1]==ext_lines[n][exn][exw][0]:
							...
							ext_lines[n][exn][exw][0]=ext_lines[n][exn][exw][1]
							ext_lines[n][exn][exw][1]=wr[3][0]
						if wr[3][2]==ext_lines[n][exn][exw][0]:
							dwd=wrn[2]+math.sqrt((xxs[n][wr[1][0]][wr[1][1]]-xxs[n][drpt[n][wr[3][1]][1][0]][drpt[n][wr[3][1]][1][1]])**2+(yys[n][wr[1][0]][wr[1][1]]-yys[n][drpt[n][wr[3][1]][1][0]][drpt[n][wr[3][1]][1][1]])**2)
							ext_add.append([wr[5], wr[3][1], dwd])
							ext_lines[n][exn][exw][2]+=math.sqrt((xxs[n][wr[1][0]][wr[1][1]]-xxs[n][drpt[n][wr[3][0]][1][0]][drpt[n][wr[3][0]][1][1]])**2+(yys[n][wr[1][0]][wr[1][1]]-yys[n][drpt[n][wr[3][0]][1][0]][drpt[n][wr[3][0]][1][1]])**2)
							ext_lines[n][exn][exw][0]=ext_lines[n][exn][exw][1]
							ext_lines[n][exn][exw][1]=wr[3][0]
					exw+=1
				for ead in ext_add:
					ext_lines[n][exn].append(ead)
			exn+=1
	print('========')
	print(lengs[n])
	print('========')
